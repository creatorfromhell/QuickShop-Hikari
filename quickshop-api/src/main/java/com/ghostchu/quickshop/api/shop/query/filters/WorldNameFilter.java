 ...
 * @since 6.3.0.0
 */
public class WorldNameFilter implements Filter<String> {
   ...
   */
  @Override
  public boolean applies(final @NotNull Shop shop, @NotNull final String object) {

    if (shop.bukkitLocation().getWorld() != null) {
      return object.equalsIgnoreCase(shop.bukkitLocation().getWorld().getName());
    }
    return false;
  }
}